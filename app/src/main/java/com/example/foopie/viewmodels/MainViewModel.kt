...
import com.example.foopie.data.Repository
...
//    Room Database
    ...
    private suspend fun getRecipesSafeCall(queries: Map<String, String>) {
        ...
        if (hasInternetConnection()) {
            ...
            recipesResponse.value = NetworkResult.Error("No Internet Connection Available Now")
        }
    }
    ...
    private suspend fun searchRecipesSafeCall(searchQuery: Map<String, String>) {
        ...
        if (hasInternetConnection()) {
            ...
            searchedRecipeResponse.value =
                NetworkResult.Error("No Internet Connection Available Now")
        }
    }
    ...
    private fun hasInternetConnection(): Boolean {
        val conncetivityManager = getApplication<Application>().getSystemService(
            Context.CONNECTIVITY_SERVICE
        ) as ConnectivityManager
        val activeNetwork = conncetivityManager.activeNetwork ?: return false
        val capabilities = conncetivityManager.getNetworkCapabilities(activeNetwork) ?: return false
        return when {
